...
const ALIENS = [
  { file: "alien1.png", name: "Eye Guy" },
  { file: "alien2.png", name: "Ghostfreak" },
  { file: "alien3.png", name: "Buzzshock" },
  { file: "alien4.png", name: "ChamAlien" },
  { file: "alien5.png", name: "Alien X" },
  { file: "alien6.png", name: "Chromastone" },
  { file: "alien7.png", name: "Heatblast" },
  { file: "alien8.png", name: "Crashhopper" },
  { file: "alien9.png", name: "Clockwork" },
  { file: "alien10.png", name: "Humungousaur" },
  { file: "alien11.png", name: "Feedback" },
  { file: "alien12.png", name: "Wildmutt" },
];
...
export default function Gallery() {
  ...
  useEffect(() => {
    ...
    gsap.set(symbolImgRef.current, { opacity: 0, width: SYMBOL_WIDTH });
    ...
    tl.to(symbolImgRef.current, { opacity: 1, width: SYMBOL_WIDTH, duration: 0.2, ease: "back.out(1.5)" }, 0.57);
    ...
    ALIENS.forEach((_, i) => {
      tl.to(alienRefs.current[i], { opacity: 1, scale: 1, duration: 0.12, ease: "back.out(2.5)" }, 0.65 + i * 0.024);
    });
  ...
  const onHover = (i, enter) => {
    ...
    gsap.to(alienRefs.current[i], { scale: enter ? 1.35 : 1, duration: 0.3, ease: "back.out(2)", overwrite: "auto" });
  };
  ...
  return (
    ...
    >
      {/* Theme-aware background — uses CSS vars so it switches with light/dark */}
      <div className="gallery-bg" />

      {/* Hex dot grid */}
      <div
        style={{ position: "absolute", inset: 0, pointerEvents: "none", backgroundImage: "radial-gradient(circle at 1px 1px,rgba(57,255,20,0.06) 1px,transparent 0)", backgroundSize: "28px 28px" }}
      />
      ...
      {PARTICLES.map((p, i) => (
        <div
          ...
          style={{
            ...
            opacity: 0.35,
            animation: `galleryFloat ${p.dur} ease-in ${p.delay} infinite`,
            pointerEvents: "none",
          }}
        />
      ))}
      ...
      <div ref={titleRef} style={{ position: "absolute", top: 52, textAlign: "center", zIndex: 20 }}>
        <p style={{ fontFamily: "'Share Tech Mono',monospace", fontSize: 10, letterSpacing: 6, textTransform: "uppercase", color: "#39FF14", marginBottom: 6, textShadow: "0 0 10px #39FF14" }}>
          — Omnitrix Interface —
        </p>
        <h2 style={{ fontFamily: "'Orbitron',monospace", fontSize: "clamp(20px,3.5vw,48px)", color: "var(--text)", letterSpacing: 6, textTransform: "uppercase", lineHeight: 1 }}>
      ...
      <div ref={subtitleRef} style={{ position: "absolute", top: 144, textAlign: "center", zIndex: 20 }}>
        <p style={{ fontFamily: "'Share Tech Mono',monospace", fontSize: 9, letterSpacing: 4, textTransform: "uppercase", color: "rgba(57,255,20,0.38)", margin: 0 }}>
          Scroll ↓ clockwise · Scroll ↑ anti-clockwise · Hover to inspect
        </p>
      </div>

      {/* Orbit stage */}
      <div style={{ position: "relative", width: 560, height: 560, display: "flex", alignItems: "center", justifyContent: "center", marginTop: 80 }}>
        ...
        {/* Watch */}
        <div ref={watchWrapRef} style={{ position: "relative", zIndex: 5, transformOrigin: "center center", willChange: "transform" }}>
          {[130, 180].map((s, i) => (
            <div
              key={i}
              style={{
                ...
                animation: `galleryPulse 2.4s ease-out ${i * 0.8}s infinite`,
                pointerEvents: "none",
              }}
            />
          ))}
          <img
            ...
            alt="Omnitrix"
            className="watch-img"
            style={{ width: WATCH_WIDTH,marginLeft:15 , height: "auto", display: "block", filter: "drop-shadow(0 0 28px rgba(57,255,20,0.8)) drop-shadow(0 0 70px rgba(57,255,20,0.35))" }}
          />
          <img
            ref={symbolImgRef}
          ...
          <div key={alien.name} style={{ position: "absolute", top: "50%", left: "50%", zIndex: 10 }}>
            <div
              ...
              style={{
                ...
                // height: 68,
                borderRadius: "50%",
                background: "radial-gradient(circle,rgba(57,255,20,0.08) 0%,var(--bg2) 68%,var(--bg) 100%)",
            ...
            <div
              ...
              style={{ position: "absolute", transform: "translate(-50%,0)", textAlign: "center", pointerEvents: "none", whiteSpace: "nowrap", willChange: "transform" }}
            >
              <p style={{ fontFamily: "'Orbitron',monospace", fontSize: 7, letterSpacing: 2, textTransform: "uppercase", color: "#39FF14", textShadow: "0 0 6px #39FF14", margin: 0 }}>{alien.name}</p>
            </div>
          </div>
        ))}
      </div>
      ...
      {hoveredAlien !== null && (
        ...
        >
          <p style={{ fontFamily: "'Orbitron',monospace", fontSize: 11, letterSpacing: 4, textTransform: "uppercase", color: "#39FF14", textShadow: "0 0 10px #39FF14", margin: 0 }}>
            {ALIENS[hoveredAlien].name}
          </p>
          <p style={{ fontFamily: "'Share Tech Mono',monospace", fontSize: 9, letterSpacing: 3, color: "rgba(57,255,20,0.45)", margin: "3px 0 0", textTransform: "uppercase" }}>Omnitrix Form Active</p>
        </div>
      )}
      ...
      >
        <p style={{ fontFamily: "'Share Tech Mono',monospace", fontSize: 9, letterSpacing: 5, textTransform: "uppercase", color: "rgba(57,255,20,0.3)", margin: 0 }}>Scroll to activate</p>
        <div style={{ width: 1, height: 28, background: "linear-gradient(to bottom,rgba(57,255,20,0.5),transparent)", animation: "galleryBlink 1.5s ease-in-out infinite" }} />
      </div>
      ...
      <style>{`
        ...
        .gallery-bg {
          ...
          inset: 0;
          pointer-events: none;
          background: radial-gradient(ellipse at 50% 55%, var(--gallery-mid) 0%, var(--bg2) 55%, var(--bg) 100%);
          transition: background 0.5s ease;
        }
        :root       { --gallery-mid: #0a1f0a; }
        .light-mode { --gallery-mid: #c8e6c8; }
