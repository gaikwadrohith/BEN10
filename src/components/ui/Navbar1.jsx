      ...
      >
        <nav className={cn("flex items-center justify-between", scrolled ? "px-6" : "")}>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/about"
              className="hidden md:inline-flex items-center gap-2 px-5 py-2 bg-[var(--green)] text-black text-[10px] font-mono tracking-[3px] uppercase font-bold hover:bg-[#5aff3a] transition-colors"
            >
              ME
            </Link>
