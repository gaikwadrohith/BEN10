...
const SOCIALS = [
  ...
  {
    icon: FiMail,
    href: "https://mail.google.com/mail/u/0/?view=cm&fs=1&to=rohitrajg9881@gmail.com&su=Let%27s%20Work%20Together&body=Hi%20Rohit%2C%0A%0AI%20came%20across%20your%20portfolio%20and%20I%27m%20interested%20in%20working%20with%20you.%0A%0ALet%20me%20know%20your%20availability.%0A%0AThanks!",
    label: "Email",
  },
];
...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-[var(--border)] bg-[var(--bg2)] pt-20 pb-10 overflow-hidden">
      ...
      <div
        style={{ position: "absolute", inset: 0, pointerEvents: "none", backgroundImage: "radial-gradient(circle at 1px 1px,rgba(57,255,20,0.03) 1px,transparent 0)", backgroundSize: "28px 28px" }}
      />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-[var(--text-muted)] leading-relaxed mb-6 max-w-xs">The ultimate fan database for all things Ben 10. 70+ aliens, 5 series, one legendary Omnitrix.</p>
            ...
            {/* Status badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5" style={{ background: "rgba(57,255,20,0.06)", border: "1px solid rgba(57,255,20,0.2)" }}>
              <span
                style={{ width: 5, height: 5, borderRadius: "50%", background: "#39FF14", boxShadow: "0 0 5px #39FF14", display: "inline-block", animation: "footerBlink 1.5s ease-in-out infinite" }}
              />
            ...
            <div key={col}>
              ...
              <ul className="space-y-3">
                {items.map((item) => (
                  <li key={item.label}>
                    {item.route ? (
                      <Link to={item.href} className="text-sm text-[var(--text-muted)] hover:text-[var(--green)] transition-colors cursor-none flex items-center gap-1 group">
                        {item.label}
        ...
        <div className="pt-8 border-t border-[var(--border)] flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <button onClick={scrollToTop} className="text-xs font-mono text-[var(--green)] text-glow cursor-none hover:opacity-70 transition-opacity flex items-center gap-1">
              IT'S HERO TIME ↑
            </button>
          </div>
        </div>
